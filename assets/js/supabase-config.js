/**
 * Supabase connection settings for Taunet Nelel.
 *
 * HOW TO FILL THIS FILE:
 * 1. Keep this file path: assets/js/supabase-config.js
 * 2. Paste your Legacy anon public key between the quotes on anonKey
 *    (Supabase Dashboard > Settings > API Keys > "Legacy anon, service_role API keys")
 * 3. Save the file (Ctrl+S)
 * 4. Do NOT paste this into the Supabase SQL Editor
 */
