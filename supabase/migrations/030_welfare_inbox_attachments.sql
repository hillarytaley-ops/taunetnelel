-- Welfare team inbox, claim file attachments, waiting-period reminder log.
-- Run after APPLY-WELFARE-CLAIMS.sql. Safe to re-run.
...
-- Members can see their own claim file metadata (download goes through the API).
