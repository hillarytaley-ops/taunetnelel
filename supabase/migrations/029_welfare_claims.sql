-- Welfare claims / reimbursements for the constitution register.
-- Members lodge a claim on the Welfare tab. Committee review in Admin → Claims.
-- Approved/paid claims appear as anonymised reimbursement alerts.
-- Also shows date_admitted on the member Welfare record (read-only).
-- Safe to re-run.
