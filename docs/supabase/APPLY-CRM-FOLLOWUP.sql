-- Run in Supabase SQL Editor after APPLY-CRM-CUSTOM-FIELDS.sql, then redeploy.
-- Admin: Committee admin -> Follow-up
-- Members: Welfare tab -> Request a welfare appointment
-- Public: /unsubscribe.html
-- SMS sending needs TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_FROM on Vercel.
...
-- Allow one-person campaigns if this table already existed without "individual".
do $$
declare
  rec record;
begin
